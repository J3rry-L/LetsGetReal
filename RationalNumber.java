public class RationalNumber extends Number {
  ...
  */
  public RationalNumber multiply(RationalNumber other){
    RationalNumber result = new RationalNumber(getNumerator() * other.getNumerator(), getDenominator() * other.getDenominator());
    return result;
  }
  ...
  */
  public RationalNumber divide(RationalNumber other){
    RationalNumber result = new RationalNumber(getNumerator() * other.getDenominator(), getDenominator() * other.getNumerator());
    return result;
  }
  ...
  */
  public RationalNumber add(RationalNumber other){
    RationalNumber result = new RationalNumber(getNumerator() * other.getDenominator() + getDenominator() * other.getNumerator(), getDenominator() * other.getDenominator());
    return result;
  }
  /**
